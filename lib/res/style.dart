...
class Styles {
  ...
  static const TextStyle style_home_itip_title =
  TextStyle(color: ColorStyle.color_A97C50, fontSize: 50,fontWeight: FontWeight.bold);

  static const TextStyle style_list_item_title =
  TextStyle(color: ColorStyle.color_A97C50, fontSize: 26);

  static const TextStyle style_home_item =
  TextStyle(color: ColorStyle.color_A97C50, fontSize: 28,fontWeight: FontWeight.w800);


  static const TextStyle style_top_title =
  TextStyle(color: ColorStyle.color_0B54A4, fontSize: 26);

  static const TextStyle style_top_time =
  TextStyle(color: ColorStyle.color_black_333, fontSize: 28);

  static const TextStyle style_detail_title =
  TextStyle(color: ColorStyle.color_134872, fontSize: 50,fontWeight: FontWeight.bold);
...
class DividerStyle {
  ...
  ///分割线 0.5 - 无边距
  static Widget divider1Half2 = const Divider(
    height: 0.5,
    thickness: 0.5,
